        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="self-end">
            <button
              ...
              className="w-full sm:w-auto px-6 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
